...
namespace UnityEngine.UI.Extensions
{
    ...
    public class UILineRenderer : MaskableGraphic
    {
        ...
        private static readonly Vector2[] startUvs = new[]
            {UV_TOP_LEFT, UV_BOTTOM_LEFT, UV_BOTTOM_CENTER, UV_TOP_CENTER};
        ...
        private static readonly Vector2[] endUvs = new[]
            {UV_TOP_CENTER, UV_BOTTOM_CENTER, UV_BOTTOM_RIGHT, UV_TOP_RIGHT};
                ...
                if (!LineList && i < segments.Count - 1)
                {
                    ...
                    if (joinType == JoinType.Bevel)
                    {
                        ...
                        var join = new UIVertex[]
                            {segments[i][2], segments[i][3], segments[i + 1][0], segments[i + 1][1]};
